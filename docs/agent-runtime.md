...
- External: `handoff --compact`; compact map/learn.
- Patch: `handoff validate`; then `patch intake`; `--apply` needs `git apply --check`.
...
- Risky: `learn query --surface <s> --top-k 3 --compact --files <f>`.
